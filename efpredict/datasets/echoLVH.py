...
# TODO, ammend segmentation/using boolean remove options.
# TODO change to lvh
...
class EchoLVH(torchvision.datasets.VisionDataset):
    """EchoNet-LVH Dataset.
    ...
    def __init__(self, root=None,
        ...
        if root is None:
            root = efpredict.config.DATA_DIR #TODO change from echonet
    ...
    def __getitem__(self, index):
        ...
        video = efpredict.utils.loadvideo(video).astype(np.float32) #TODO change from echonet
